...
That means we want to better understand how changing different defining geometric and mechanical characteristics (called design variables) of the wind turbine to see how it affects the outputs of our model. 
