...
\fancyfoot[C]{}
\fancyfoot[R]{Rotor Design - Optimization: Part III}
%Fancy Footer Content
% \fancyfoot[L,C]{} %make bottom left and center empty
% \fancyfoot[R]{\thepage}
\title{Rotor Design - Optimization: Part III}
\date{}
...
\begin{enumerate}[label=\alph*.]
	\item With your graduate student mentor, identify at least one area in which you can improve your optimization. Incorporate this into your optimization. Some ideas include using splines to define your distribution, using algorithmic differentiation, or including a thrust constraint.
\end{enumerate}
