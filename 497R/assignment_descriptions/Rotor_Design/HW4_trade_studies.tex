...
\fancyfoot[C]{}
\fancyfoot[R]{Rotor Design - Optimization: Part I}
%Fancy Footer Content
% \fancyfoot[L,C]{} %make bottom left and center empty
% \fancyfoot[R]{\thepage}
\title{Rotor Design - Optimization: Part I}
\date{}
...
\begin{enumerate}[label=\alph*.]
    \item Consider the maximum power solution from your last assignment. Create an objective function that seeks this solution using the chord distribution as design variables. You will need to write out your optimization problem in mathematical form. 
