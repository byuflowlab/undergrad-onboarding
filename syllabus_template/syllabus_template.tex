...
Technical Stuff: Learn how to run vortexlattice.jl and do a 3 case comparison study.

\begin{itemize}
	\item Follow tutorial on VortexLattice.jl to figure out basics of running it.
	\item Follow example on Steady State Analysis of a Wing and Tail to figure out how to run full plane
	\item Create plots for the following:
	\begin{itemize}
		\item tail volume ratio vs relevant stability derivatives
		\item wing aspect ratio vs efficiency
		\item angle of attack vs cl (why does it look like that?)
	\end{itemize}
\end{itemize}
...
Technical Stuff:  Airfoil family generation and surrogate model generation

\begin{itemize}
	\item Compare several airfoils designed for your application.
	\item Create a family of airfoils
	\item using XFoil.jl, generate a surrogate model for your airfoil family.
\end{itemize}
...
Technical Stuff:  Airframe Optimization

\begin{itemize}
	\item Set up SNOW/ipopt
	\item using content from papers 1 and 2, set up an airframe sensitivity study
	\item set up optimization
	\item optimize airframe for various sets of constraints and/or objectives.
\end{itemize}
